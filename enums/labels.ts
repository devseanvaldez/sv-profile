export const LABELS = {
  ...
  about: {
    title: "About me",
    text: [
      "Hi I'm Sean. In year 2020, I started as Junior-level in one of the logistic company here in the Philippines. I have been part of creating In-house project such as Dashboards used in Logistics using GPS integrated with Google map connected to our Backend Service and also returns data via socket. While having an Upwork for a short period of time, I also having an experience in building websites for businesses such as Travel Agency app used in UAE. It helps me re-design a legacy website into a modern looking React/NextJS website that implements new features and functionalities that comply with its requirements.",
